...
(function () {
  ...
  var T = {
    cs: {
      ...
      nav_faq: 'FAQ',
      hero_badge: 'v2.0.5 — Windows · Linux · macOS',
      ...
      demo_label: 'Ukázka v akci',
      demo_title_html: 'Rychlé <span class="gradient">video demo</span>',
      demo_sub: 'Podívejte se, jak rychle lze porovnat databázová schémata a vygenerovat aktualizační skripty.',
      ...
      comp_label: 'Srovnání',
      comp_title_html: 'V čem BaseDiff <span class="gradient">vyniká</span>',
      comp_sub: 'Proč jsme si vyvinuli vlastní nástroj a proč může být správnou volbou i pro vás.',
      comp_philosophy_title: 'Naše filozofie',
      comp_philosophy_text: 'Už nás nebavily drahé licence a nástroje omezené jen na Windows. BaseDiff vznikl jako interní projekt s cílem být rychlý, multiplatformní a dostupný pro každého.',
      comp_table_feature: 'Vlastnost',
      comp_table_basediff: 'BaseDiff',
      comp_table_others: 'Ostatní nástroje',
      comp_f1: 'Cena',
      comp_v1_basediff: 'Zdarma / Coffeeware',
      comp_v1_others: 'Drahé / Předplatné',
      comp_f2: 'Multiplatformní',
      comp_v2_basediff: 'Win, Linux, macOS',
      comp_v2_others: 'Většinou jen Windows',
      comp_f3: 'Instalace',
      comp_v3_basediff: 'Portable (bez instalace)',
      comp_v3_others: 'Těžkopádné instalátory',
      comp_f4: 'Jednoduchost',
      comp_v4_basediff: 'Cílený a lehký',
      comp_v4_others: 'Přebujelé a složité',
      comp_f5: 'Soukromí',
      comp_v5_basediff: '100% Offline',
      comp_v5_others: 'Nutnost cloudu',
      faq_label: 'FAQ',
      ...
      changelog_label: 'Historie verzí',
      changelog_title: 'Changelog',
      changelog_sub: 'Přehled novinek v posledních verzích BaseDiff.',
      pipeline_label: 'Migrační Pipeline',
      pipeline_title_html: 'Kompletní cesta k <span class="gradient">automatizaci schémat</span>',
      pipeline_sub: 'Od analýzy po reportování. BaseDiff pokrývá celý životní cyklus migrací.',
      pipe_s1_t: 'Zdrojová a cílová DB',
      pipe_s1_p: 'Vstupní body procesu.',
      pipe_s2_t: 'BaseDiff Engine',
      pipe_s2_p: 'Chytrá analýza struktur.',
      pipe_s3_t: 'Save/Load project (JSON)',
      pipe_s3_p: 'Trvalost a přenositelnost práce.',
      pipe_s4_t: 'Visual Comparison',
      pipe_s4_p: 'Přehledné zobrazení změn.',
      pipe_s5_t: 'Script Generation',
      pipe_s5_p: 'Automatizovaný SQL kód.',
      pipe_s6_t: 'Review & Report',
      pipe_s6_p: 'Kontrola před nasazením.',
      privacy_label: 'Soukromí',
      privacy_title_html: 'Vaše data jsou v <span class="gradient">absolutním bezpečí</span>',
      privacy_sub: 'Internet potřebujete pouze ke stažení aplikace. Samotné porovnávání probíhá výhradně ve vaší síti.',
      priv_l1: '100% Offline provoz',
      priv_l2: 'Žádný cloud, žádné riziko',
      priv_l3: 'Data nikdy neopustí váš stroj',
      priv_l4: 'Bezpečné i v izolovaných sítích',
    ...
    en: {
      ...
      demo_label: 'See in action',
      demo_title_html: 'Quick <span class="gradient">video demo</span>',
      demo_sub: 'Watch how quickly you can compare database schemas and generate update scripts.',
      ...
      comp_title_html: 'How BaseDiff <span class="gradient">stands out</span>',
      comp_sub: 'Why we built our own tool and why it might be the right choice for you too.',
      comp_philosophy_title: 'Our Philosophy',
      comp_philosophy_text: 'We were tired of expensive licenses and tools limited only to Windows. BaseDiff was born as an internal project to be fast, cross-platform and accessible to everyone.',
      comp_table_feature: 'Feature',
      comp_table_basediff: 'BaseDiff',
      comp_table_others: 'Other Tools',
      comp_f1: 'Price',
      comp_v1_basediff: 'Free / Coffeeware',
      comp_v1_others: 'Expensive / Subscription',
      comp_f2: 'Multi-Platform',
      comp_v2_basediff: 'Win, Linux, macOS',
      comp_v2_others: 'Mostly Windows only',
      comp_f3: 'Installation',
      comp_v3_basediff: 'Portable (no install)',
      comp_v3_others: 'Heavy installers',
      comp_f4: 'Simplicity',
      comp_v4_basediff: 'Focused & Light',
      comp_v4_others: 'Over-featured & Bloated',
      comp_f5: 'Privacy',
      comp_v5_basediff: '100% Offline',
      comp_v5_others: 'Cloud requirements',
      faq_label: 'FAQ',
      ...
      changelog_label: 'Release History',
      changelog_title: 'Changelog',
      changelog_sub: "See what's new in the latest versions of BaseDiff.",
      pipeline_label: 'Migration Pipeline',
      pipeline_title_html: 'Complete path to <span class="gradient">schema automation</span>',
      pipeline_sub: 'From analysis to reporting. BaseDiff covers the entire migration lifecycle.',
      pipe_s1_t: 'Source & Target DB',
      pipe_s1_p: 'Process entry points.',
      pipe_s2_t: 'BaseDiff Engine',
      pipe_s2_p: 'Smart structure analysis.',
      pipe_s3_t: 'Save/Load project (JSON)',
      pipe_s3_p: 'Persistence of your work.',
      pipe_s4_t: 'Visual Comparison',
      pipe_s4_p: 'Clear change visualization.',
      pipe_s5_t: 'Script Generation',
      pipe_s5_p: 'Automated SQL code.',
      pipe_s6_t: 'Review & Report',
      pipe_s6_p: 'Validation before deployment.',
      privacy_label: 'Privacy',
      privacy_title_html: 'Your data is in <span class="gradient">absolute safety</span>',
      privacy_sub: 'You only need the internet to download the app. The comparison stays entirely on your network.',
      priv_l1: '100% Offline operation',
      priv_l2: 'No cloud, no risk',
      priv_l3: 'Data never leaves your machine',
      priv_l4: 'Safe even in isolated networks',
